...
<head>
  ...
  <title>MbakSir | Dashboard Pegawai</title>
        ...
        <div class="col-lg-12">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              <p>Catat Pesanan Pelanggan</p>
            </div>
            <div class="icon">
              <i class="ion ion-person"></i>
            </div>
            <a href="/pesanan" class="small-box-footer">Go <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-12">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              ...
              <p>History pemesanan yang dilakukan</p>
            </div>
            <div class="icon">
          ...
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h2 class="modal-title">Edit Profil Pegawai</h2>
            </div>
            <div class="modal-body">
              ...
              <div class="form-group">
                <label>Jobdesc</label>
                <input type="text" class="form-control" name="jobdesc" value ="{{a.jobdesc}}">
              </div>
              <div class="form-group">
                <label>Tahun Mulai Bekerja</label>
                <input type="text" class="form-control" name="tahun_bekerja" value ="{{a.tahun_bekerja}}">
              </div>
            </div>
