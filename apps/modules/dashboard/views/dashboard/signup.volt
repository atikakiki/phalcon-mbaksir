...
<form action="/store" method="post">
        <h2><center>Sign Up Pegawai</center></h2>
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="no_telp" placeholder="No Telepon" required="required">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="jobdesc" placeholder="Jobdesc / Bagian" required="required">
        </div>

        <div class="form-group">
            <input type="text" class="form-control" name="tahun_bekerja" placeholder="Tahun Mulai Bekerja" required="required">
        </div>
        <div class="form-group">
